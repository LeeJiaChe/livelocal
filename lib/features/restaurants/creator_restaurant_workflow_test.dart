...
Remove-Item lib\features\restaurants\creator_restaurant_workflow_test.dart
    test('review links detect platform and require a real post URL', () {
      expect(
        SocialUrlValidator.detectPlatform(
          'https://www.tiktok.com/@foodie/video/123456',
        ),
        'tiktok',
      );
      expect(
      ...
      expect(
        SocialUrlValidator.isReviewPost(
          'https://instagram.com/foodie',
        ),
        isFalse,
      );
      expect(
        SocialUrlValidator.isReviewPost(
          'https://www.tiktok.com/@foodie',
        ),
        isFalse,
      );
      expect(
        SocialUrlValidator.isReviewPost(
          'https://facebook.com/foodie',
        ),
        isFalse,
      );
    });
      ...
      expect(
        () => repository.createRestaurantDraft(
          input: const RestaurantDraftInput(
            ...
            priceRange: r'$',
            reviewedDishes: 'A test dish',
            socialMediaUrl: 'https://www.instagram.com/reel/SAFE123/',
          ),
